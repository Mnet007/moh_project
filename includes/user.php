...
class User 
{
    ...
    public function userLogin($email,$password){
        $pre_stmt = $this->con->prepare("SELECT id,username,email,password,last_login FROM user WHERE email = ?");
        $pre_stmt->bind_param("s",$email);
        $pre_stmt->execute() or die($this->con->error);
        $result = $pre_stmt->get_result();
...
//$user = new User();
//echo $user->createUserAccount("Test","nabil1@gmail.com","1234567890","Admin");

//echo $user->userLogin("nabil1@gmail.com","1234567890");
